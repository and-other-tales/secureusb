...
class SecureStorage:
    ...
    def _init_encryption(self):
        ...
        try:
            ...
            # Fallback for systems without machine-id - generate UUID
            import uuid
            fallback_file = self.config_dir / ".machine_id"
            if fallback_file.exists():
                machine_id = fallback_file.read_text().strip()
            else:
                machine_id = str(uuid.uuid4())
                fallback_file.write_text(machine_id)
